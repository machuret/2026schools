...
export async function generateMetadata({ params }: Props) {
  ...
  return {
    title: `${data.name} — Ambassador | Schools Wellbeing Australia`,
    description: data.title ? `${data.name}, ${data.title} — Schools Wellbeing Australia Ambassador` : `${data.name} — Schools Wellbeing Australia Ambassador`,
  };
}
