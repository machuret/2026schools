...
export async function generateMetadata({ params }: Props) {
  ...
  return {
    title: `${data.name} — Partner | Schools Wellbeing Australia`,
    description: data.description ? `${data.name} — ${data.description.slice(0, 155)}` : `${data.name} — Schools Wellbeing Australia Partner`,
  };
}
